          ...
          <div className="grid grid-cols-12 gap-8 py-14 lg:grid-cols-8">
            <div className="mb-0 col-span-full lg:col-span-3">
              <a
                ...
                className="flex font-bold justify-center lg:justify-start"
              >
                <svg
            ...
            <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2">
              ...
              <ul className="text-white transition-all duration-500">
                <li className="mb-6">support@gmail.com</li>
                <li className="mb-6">+92XXX-XXXXXXX</li>
                <li>61-A, Lahore, Pakistan.</li>
              </ul>
            </div>
            ...
            <div className="w-full text-center lg:w-auto lg:text-left col-span-full sm:col-span-4 md:col-span-4 lg:col-span-2">
              ...
              <div className="flex flex-col items-center lg:items-start">
                <input
                  type="text"
                  className="w-1/2 lg:w-full md:w-full sm:w-full h-12 border border-gray-300 rounded-full py-2.5 px-5 shadow-sm text-gray-800 mb-5 text-center lg:text-left placeholder:text-gray-400 focus:outline-none focus:border-gray-500"
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span className="text-sm text-white">
                ©<a href="https://pagedone.io/">Envouge-Thread</a> 2024, All rights
                reserved.
              </span>
